...
{\bf Аcademic leave (Now) } \hfill {\em Jen 2022 - Aug 2022} \\
{\bf ITMO University, Saint Petersburg, Russsia} \hfill {\em Sep 2022 - Jun 2024} 
...
Software \& Tools: & Git, Bash, SQL\\
Languages: \ & Russian(native), English(B1.2)
\end{tabular}
...
{\bf Programming language Hi} \hfill {\em Dec 2021 - Jan 2021} \\
...
{\bf Telegram bot} \hfill {\em Dec 2021 - Dec 2021} 
\\{\textit{some libraries: Servant}}
...
{some experience with lens, template-haskell, megaparsec, servant}
